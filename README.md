...
Install [Constly](https://constly.com) — a WYSIWYG markdown editor that renders
the marks away as you type — on macOS with Homebrew:
...
auto-updater, so it keeps itself current — `brew upgrade` is intentionally a
